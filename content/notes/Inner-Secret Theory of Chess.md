...
The general thought is to do as follows.

1. Formalize chess or an aspect thereof
2. Consider this formalization and its consequences
3. Apply insights during game

One approach is to define chess as a set of structures and axioms and then to reason about them.  This would be building a theory isomorphic to chess. However I suspect the difficulty of crafting something satisfyingly novel would be too high. That said, the geometry of chess may be fertile ground to explore.
