...
| Bats           | swatted by         |
| Cat            | fired by           |
| Dragon         | extinguished by    |
| Elephant       | hopped on by       |
| Frog           | loomed over by     |
| Giraffe        | roared at          |
| Hippo          | angers             |
| Iguana         | jumped by          |
| Jumping Spider | boxed by           |
| Kangaroo       | spectated by       |
| Lemur          | feces-assaulted by |
| Monkeys        | prayed for by      |
| Nun            | eeked by           |
| Orangutan      | neighed by         |
| Pony           | tripped by         |
| Quohogs        | snorted by         |
| Rabbits        | swallowed by       |
| Snake          | pounced on by      |
| Tiger          | skewered by        |
| Unicorn        | investigated by    |
| Velma          | pooped by          |
| Wombat         | attacked by        |
| Xena           | hair chewed by     |
| Yak            | struck by          |
...
[[9 types of behavior change interventions]]

| Knowledge                   | Peg       | Mnemonic                             |
| --------------------------- | --------- | ------------------------------------ |
| Education                   | Alligator | Wearing academic gow, book, cap      |
| Persuation                  | Bats      | Echoing advice                       |
| Incentivization             | Cats      | Eating a cat treat                   |
| Coercion                    | Dragon    | Harming with fire                    |
| Training                    | Elephant  | Teaching people to put out the fires |
| Restriction                 | Frog      | Bondage gear                         |
| Environmental Restructuring | Girraffe  | Eating all the leaves                |
| Modeling                    | Hippo     | Sexy posing                          |
| Enablement                  | Iguana    | Hopped up on drugs                   |

[[3 components and 6 subdivisions for behavior-change interventions]]

| Knowledge                  | Peg            | Mnemonic                               |
| -------------------------- | -------------- | -------------------------------------- |
| Capability (Physical)      | Jumping Spider | jumping spider with jetpack            |
| Capability (Psychological) | Kangaro        | kangaro reading a book                 |
| Motivation (Automatic)     | Lemur          | Driving a car                          |
| Motivation (Reflective)    | Monkey         | looking in mirror                      |
| Opportunity (Social)       | Nun            | Praying with Sangha at a rare teaching |
| Opportunity (Physical)     | Orangatan      | Teaching physics                       |

[[7 policy categories for behavior change]]

| Knowledge                     | Peg     | Mnemonic          |
| ----------------------------- | ------- | ----------------- |
| Communication/Marketing       | Pony    | megaphone         |
| Guidelines                    | Quahog  | rulers            |
| Fiscal                        | Rabbit  | rolling in money  |
| Legislation                   | Snake   | wearing wig       |
| Environmental/social planning | Tiger   | weed smoking      |
...
| Knowledge               | Peg    | Mnemonic            |
| ----------------------- | ------ | ------------------- |
| State point of view     | Wombat | Laser pointer       |
