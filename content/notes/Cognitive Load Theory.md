...
| ---------------- | --------- | ------------- |
| Working Memory   | limited   | concious      |
| Long-term Memory | unlimited | unconcious    |

A key point is that while working memory is generally limited, it holds even less if these items need to be processed.

The process of learning is transferring the information from working memory into long term memory as a unified schema.
