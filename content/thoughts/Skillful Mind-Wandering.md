Mind-wandering is often viewed as an unintentional and unwanted process that catches a person off guard and leads them by the nose off-topic. However, research hopes to refine our understanding of it, modeling its purpose and parts. Often brainstorming is divided into intentional vs unintentional[^1] and then, by some, subdividing as aware vs unaware[^3]. All together, mind-wandering has ample nuance to explore beyond initial impressions.

The perspective that mind-wandering is inherently negative shuts us off from seeing it as a positive. In fact, on closer inspection, it has many appealing qualities. Mind-wandering may play a role in self-regulation[^5] , meaning it can serve as a signal that, for example, a task is too boring or difficult or that there are competing priorities worth considering. There have also been links between it and creativity. Most importantly, it is part of who many people are and to see that as a negative is limiting.

Furthermore, the intentional usage of mind-wandering to perform a task has historical precedent. André Breton describes surrealism as an automatism "dictated by thought, in the absence of any control exercised by reason"[^2]. Indeed, it has been argued that Surrealist methodologies constitute intentional mind-wandering. This perspective explains that they both can conceptualized as intentionally omitting control of one's own mind.

By way of example, one such Surrealist method is automatic writing. This simple practice involves writing your thoughts as you let them flow freely, omitting control of what you write. Essentially, you intentionally let your mind wander and follow it as your own dutiful scribe.
...
[^1]: Citation needed: meta analysis showing intentional vs unintentional mind wandering
